import BlogInput from "../inputObjets/BlogInput";
import BlogOuput from "../outputObjects/BlogOutput";
...
export default class BlogBusiness{
    ...
    public async create():Promise<BlogOuput> {
        const resp: BlogOuput ={
            ...
            la cual la dicta el profesor ${this.data.tutorial.teacher}.
